...
},{"../helpers/formatMinutesToHM":3,"react":161}],5:[function(require,module,exports){
...
var Q, React, addonEntry, app, currentTicketId, formatMinutesToHM, getTicketMetrics, reactComponent, render, waitForTicket;
...
render = function(data, workspaceId) {
  if (app.reactTicketMetricsContainers[workspaceId] != null) {
    return React.render(reactComponent(data), app.reactTicketMetricsContainers[workspaceId]);
  }
};

getTicketMetrics = function(ticketId) {
  return $.ajax({
              ...
              return getTicketMetrics(ticketId).then(function(response) {
                ...
                if (!waitTimeHeaders.length) {
                  ...
                  Array.prototype.forEach.call(headSubjects, function(column) {
                    ...
                    return lastColumn.parentNode.insertBefore(th, lastColumn);
                  });
                }
...
},{"./app":1,"./helpers/domObserver":2,"./helpers/formatMinutesToHM":3,"./react/metrics":4,"q":6,"react":161}]},{},[]);
